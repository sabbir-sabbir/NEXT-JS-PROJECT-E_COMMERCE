    ...
    return (
        ...
        <nav className=" sticky top-0 z-50 w-full  py-2 px-6 md:px-14 bg-white/10 backdrop-blur-md border border-white/20  p-6 shadow-lg flex justify-between items-center">
            ...
            <div className="flex justify-center items-center gap-6">
                <div><input onChange={getData} className="w-[160px] md:w-[500px] bg-white/10 backdrop-blur-md text-zinc-700 outline-0 py-1 px-2 border-2 border-amber-300" type="text" placeholder="Search Your Item..." /></div>
                <div className="flex justify-center items-center gap-6">
                    <Link href="/components/about" ><span className="text-lime-200 hover:scale-105 duration-100 transition-all hover:text-gray-300">About</span></Link>
                    <Link href="/components/contact" ><span className="text-lime-200 hover:scale-105 duration-100 transition-all hover:text-gray-300">Contact</span></Link>
